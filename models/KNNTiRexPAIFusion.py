...
# KNN + TiRex bank fused with PAI amplitude channels. See models/KNNDetectorFusion.py
# for the fusion formula. TiRex+PAI component frozen at its own tuned optimum;
# win_size is shared between the KNN component and the wrapped detector.


class KNNTiRexPAIFusion(KNNDetectorFusion):
    def __init__(self,
                 batch_size = 256,
                 num_cores = 500,
                 top_k = 3,
